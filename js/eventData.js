            ...
            contactFormCtas.forEach(contactFormCta => {
                contactFormCta.addEventListener('click', () => {
                    if (!!contactFormCta.closest(".croxo-galinheiro--main-wrapper--home")) {
                        ...
                        croxoEventForm.querySelector('.croxo-contact-form__form-item--invisible input').value = `-- <br> DETAIL INFO: <br> Applied event --> ${appliedEvent} <br> Event link --> ${eventLink} <br> --`;
                    }
